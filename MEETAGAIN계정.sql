...
WDDATE DATE,
WD_YN CHAR(2) DEFAULT 'N' CHECK(WD_YN IN('Y','N')),
OUT_YN CHAR(2) DEFAULT 'N' CHECK(OUT_YN IN('Y','N')),
WARN_CNT NUMBER DEFAULT 0,
STOP_YNA CHAR(2) DEFAULT 'N' CHECK(STOP_YNA IN('Y', 'N', 'A')),
STOP_TIME DATE 
);
...
----------- SGROUP COLUMN DATETYPE 변경
ALTER TABLE SGROUP MODIFY(GFEE VARCHAR2(20));
ALTER TABLE SGROUP MODIFY(GPWD VARCHAR2(4));
